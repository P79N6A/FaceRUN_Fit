...
public class SharePreferceTool {
    ...
    public static final String SMART_NAME = "SmartCar";
    ...
    public static SharePreferceTool getInstance() {
        return new SharePreferceTool(App.getInstance());
    }

    public static SharePreferceTool getDefaultInstance() {
        return new SharePreferceTool(App.getInstance(), App.getInstance().getPackageName() + "_preferences");
    }

    public static SharePreferceTool getInstance(String name) {
        return new SharePreferceTool(App.getInstance(), name);
    }
    ...
    public boolean getBoolean(String key, boolean default_value) {
        return shareprefece.getBoolean(key, default_value);
    }
