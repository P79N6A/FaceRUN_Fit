package com.fly.run.activity.offlinemap;
...
public class OfflineDownloadedAdapter extends BaseAdapter {
	...
	private OfflineDownloadItem currentOfflineDownloadItem;
...
//			}
	...
	public final class ViewHolder {
		public OfflineDownloadItem mOfflineDownloadItem;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView != null) {
			...
			currentOfflineDownloadItem = new OfflineDownloadItem(mContext,
					mOfflineMapManager);
			convertView = currentOfflineDownloadItem.getOffLineChildView();
			viewHolder.mOfflineDownloadItem = currentOfflineDownloadItem;
			convertView.setTag(viewHolder);
		}
		OfflineMapCity offlineMapCity = (OfflineMapCity) getItem(position);
		viewHolder.mOfflineDownloadItem.setOffLineCity(offlineMapCity);
