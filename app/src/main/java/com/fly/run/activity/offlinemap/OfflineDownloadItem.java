...
public class OfflineDownloadItem implements OnClickListener, OnLongClickListener {
	...
	public OfflineDownloadItem(Context context, OfflineMapManager offlineMapManager) {
		mContext = context;
		initView();
	...
	private void initView() {
		...
		mOffLineChildView = inflater.inflate(R.layout.offlinemap_download_item, null);
