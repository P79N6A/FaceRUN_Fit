...
public class FitPlanTrainActivity extends BaseUIActivity {
    private TextView tv_title, tv_jishu;
    private SeekBar seekBar;
    private FitPlanBean fitPlanBean;

    public static void startActivityJump(Context context, FitPlanBean bean) {
        Intent intent = new Intent(context, FitPlanTrainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fit_plan_train);
