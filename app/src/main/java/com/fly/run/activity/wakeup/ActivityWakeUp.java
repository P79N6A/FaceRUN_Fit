...
import com.fly.run.utils.VibratorUtil;
...
public class ActivityWakeUp extends BaseUIActivity {
            ...
            public void onEvent(String name, String params, byte[] data, int offset, int length) {
                ...
                try {
                    ...
                    if ("wp.data".equals(name)) { // 每次唤醒成功, 将会回调name=wp.data的时间, 被激活的唤醒词在params的word字段
                        ...
                        PowerManagerUtil.brightScreen(ActivityWakeUp.this);
                        VibratorUtil.doVibrator(ActivityWakeUp.this);
