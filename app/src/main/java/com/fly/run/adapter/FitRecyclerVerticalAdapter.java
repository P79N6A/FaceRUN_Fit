...
public class FitRecyclerVerticalAdapter extends RecyclerView.Adapter<FitRecyclerVerticalAdapter.MyViewHolder> {

    private Context mContext;
    private LayoutInflater layoutInflater;
    private List<String> datas = new ArrayList<>();

    public FitRecyclerVerticalAdapter(Context context) {
