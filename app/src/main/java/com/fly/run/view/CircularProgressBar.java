...
public class CircularProgressBar extends View {
    ...
    private float strokeWidth = getResources().getDimension(R.dimen.margin_8);
    private float backgroundStrokeWidth = getResources().getDimension(R.dimen.margin_4);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (progress >= 100) {
            ...
            paint.setTextSize(getResources().getDimensionPixelSize(R.dimen.font_36));
            paint.setStyle(Paint.Style.FILL_AND_STROKE);
            canvas.drawText("4", this.getMeasuredWidth() / 2, this.getMeasuredHeight() / 2, paint);
        }
    }
    //endregion
