...
public class PersonHeaderView extends RelativeLayout {
    ...
    private RoundAngleImageView iv_header_icon;
    ...
    private void initView() {
        ...
        iv_header_icon = (RoundAngleImageView) findViewById(R.id.iv_header_icon);
...
//                getContext().startActivity(intent);
                if (accountBean != null && !TextUtils.isEmpty(accountBean.getHeadPortrait()))
                    ShowImagesActivity.startShowImageActivity(getContext(),accountBean.getHeadPortrait(),0);
            }
        });
        setStatusHeight();
    }
    ...
    public void setData(AccountBean bean) {
        ...
        if (bean != null) {
            ...
            ImageLoader.getInstance().displayImage(headerUrl, iv_header_icon, ImageLoaderOptions.optionsUserHeader);
