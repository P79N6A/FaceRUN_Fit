...
public class MyHeaderViewPager extends LinearLayout {
    ...
    public interface OnScrollListener {
        ...
        void onMoving(boolean isVertical);
        void onCancle();
    }
    ...
    public MyHeaderViewPager(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyHeaderViewPager(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (onScrollListener != null) {
                    onScrollListener.onMoving(verticalScrollFlag);
                }
                /**
